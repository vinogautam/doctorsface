...
<html lang="en">
  <head>
	...
	<?php
		echo $this->Html->css(array('bootstrap.min', 'bootstrap-reset', 'assets/font-awesome/css/font-awesome', 
									'assets/jquery-file-upload/css/jquery.fileupload-ui', 'slidebars',
  ...
  <section id="container" class="">
    ...
    <?php $this->Html->script(array('jquery', 'bootstrap.min', 'jquery.dcjqaccordion', 'jquery.scrollTo.min', 'jquery.nicescroll', 'respond.min', 'slidebars.min', 'common-scripts'));?>
  </body>
</html>
